...
Przed użyciem theme
1. Skopuj folder mu-plugins do .../app/public/wp-content
2. Logo powino znajdować się w folderze image pod nazwą logo.png
...
1. Copy the mu-plugins folder to .../app/public/wp-content
2. Logo should be in folder image with name logo.png
